...
export default {
  head: {"title":"Ofertadeo","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Ofertadeo"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}]},
  data: () => ({
    layout: null,
    layoutName: ''
  }),
